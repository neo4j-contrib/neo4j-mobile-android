...
class EmbeddedGraphDbImpl
{
     ...
     */
    public EmbeddedGraphDbImpl( Context context, String storeDir, StoreId storeId, Map<String, String> inputParams,
            ...
            LastCommittedTxIdSetter lastCommittedTxIdSetter, FileSystemAbstraction fileSystem )
    {
        ...
        final Config config = new Config( context, graphDbService, storeDir, storeId, inputParams,
