...
public final class EmbeddedGraphDatabase extends AbstractGraphDatabase
{
    ...
    {
        this( null, storeDir, new HashMap<String, String>() );
    }
     ...
     * @param storeDir the store directory for the Neo4j store files
     */
    public EmbeddedGraphDatabase( Context context, String storeDir )
    {
    	this( context, storeDir, new HashMap<String, String>() );
    }
     ...
     * @param params configuration parameters
     */
    public EmbeddedGraphDatabase( Context context, String storeDir, Map<String,String> params )
    {
        this.graphDbImpl = new EmbeddedGraphDbImpl( context, storeDir, null, params, this,
